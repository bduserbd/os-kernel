...
void k_udp_build_packet(struct k_network_buffer *buffer, k_port_t src_port,
		k_port_t dest_port, k_ipv4_t ip)
{
	...
	udp->length = k_cpu_to_be16(sizeof(struct k_udp_header));
